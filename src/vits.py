    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=4, num_classes=0, embed_dim=768, depth=12,
        ...
        if self.multimodal:
            self.patch_embed_3 = PatchEmbed(
                img_size=img_size[0], patch_size=patch_size, in_chans=3, embed_dim=embed_dim)
            self.patch_embed_4 = PatchEmbed(
                img_size=img_size[0], patch_size=patch_size, in_chans=4, embed_dim=embed_dim)
            num_patches = self.patch_embed_3.num_patches  # num patches should not change
        else:
